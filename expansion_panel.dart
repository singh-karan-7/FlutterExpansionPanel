...
class ExpansionPanelList extends StatefulWidget {
  ...
  const ExpansionPanelList({
    ...
    this.unExPandedHeaderPadding = _kPanelHeaderExpandedDefaultPadding,
    this.dividerColor,
    this.elevation = 2,
  ...
  final EdgeInsets unExPandedHeaderPadding;
        ...
        children: <Widget>[
          Expanded(
            child: AnimatedContainer(
              duration: !_isChildExpanded(index)
                  ? Duration.zero
                  : widget.animationDuration,
              curve: Curves.fastOutSlowIn,
              margin: _isChildExpanded(index)
                  ? widget.expandedHeaderPadding
                  : widget.unExPandedHeaderPadding,
